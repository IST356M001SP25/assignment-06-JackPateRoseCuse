...
def entity_extraction_step(sentiment: str|pd.DataFrame) -> pd.DataFrame:
    ...
    entities_df = entities_df[['place_id', 'name', 'author_name', 'rating', 'sentence_text', 'sentence_sentiment', 'entity_text', 
                               'entity_category', 'entity_confidence_score', 'entity_subcategory']]
